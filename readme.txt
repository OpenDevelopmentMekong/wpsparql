...
1. Either download the files as zip or clone <code>git clone https://github.com/OpenDevelopmentMekong/wpsparql.git</code> into the Wordpress plugins folder.
2. Install dependencies with <code>composer install</code>
